...
viptime = 100
ALLOWED_GROUP_ID = -1002200407886   # ID BOX
admin_diggory = "huymoddeptrai"
name_bot = "B⃗O⃗T⃗ S⃗P⃗A⃗M⃗ S⃗M⃗S⃗  C⃗A⃗L⃗L⃗"
zalo = "0896874211"
web = "No"
facebook = "no"
allowed_group_id = -1002200407886 # ID BOX
...
BOT_LINK = 'https://t.me/ToolBotSpamCallSms_Bot'
TOKEN = '7880421103:AAFv-xyZ2iA4bF4aJAuHEFK6YJ3PyuKrMmU'  
bot = TeleBot(TOKEN)

ADMIN_ID = 6871691882  # id admin
admins = {6871691882}
bot_admin_list = {}
cooldown_dict = {}
allowed_users = []
...
- DÙNG LỆNH /key {{key}} ĐỂ TIẾP TỤC -
 [Lưu ý: mỗi key chỉ có 1 người dùng]
    ...
    admin_button = InlineKeyboardButton(text="WED TẢI ALL TOOL", url="https://t.me/huymoddeptrai")
...
┌───⭓ {name_bot}
│» Xin chào @{username}
│» Bot Spam : B⃗O⃗T⃗ S⃗P⃗A⃗M⃗ S⃗M⃗S⃗  C⃗A⃗L⃗L⃗
│» Zalo: {zalo}
│» Website: {web}
...
blacklist = ["112", "113", "114", "115", "116", "117", "118", "119", "0896874211", "1", "2", "3", "4"]
